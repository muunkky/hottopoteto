...
class NounPropertiesModel(BaseModel):
    ...
    type_field: str = Field("NounProperties", alias="$type")
    gender: str = "neutral"
...
class VerbPropertiesModel(BaseModel):
    ...
    type_field: str = Field("VerbProperties", alias="$type")
...
class AdjectivePropertiesModel(BaseModel):
    ...
    type_field: str = Field("AdjectiveProperties", alias="$type")
...
class WordEntryModel(GenericEntryModel):
    """Model for a word entry in the conlang domain."""
    eldorian: str
    english: str
    ...
    def from_recipe_output(cls, recipe_output: Dict) -> 'WordEntryModel':
        ...
        word_id = generate_id(eldorian_word)
