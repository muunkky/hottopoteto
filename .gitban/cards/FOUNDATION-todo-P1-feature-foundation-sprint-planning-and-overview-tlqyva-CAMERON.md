...
| **Take Sprint** | Ready to execute take_sprint("FOUNDATION") | - [ ] Used take_sprint() to claim work |
| **Mid-Sprint Check** | Week 2 checkpoint planned | - [ ] Reviewed list_cards(sprint="FOUNDATION") |
| **Complete Cards** | Track as work completes | - [ ] Cards moved to done status |
| **Sprint Archive** | archive/sprints/foundation-2025-12-18 | - [ ] Used archive_cards() to bundle work |
| **Generate Summary** | SUMMARY.md with metrics | - [ ] Used generate_sprint_summary() |
| **Update Changelog** | Version 0.2.0 planned | - [ ] Used update_changelog() |
| **Update Roadmap** | Mark M1 features complete | - [ ] Marked milestone features complete |
...
- [ ] pytest framework operational with working tests
- [ ] ADR-0005 written and merged
- [ ] 50%+ test coverage achieved
- [ ] Developer onboarding documentation complete
- [ ] New team member can set up dev environment from docs alone
...
* [ ] Changelog updated with version 0.2.0 and changes
* [ ] Roadmap milestone features marked complete
* [ ] Incomplete cards moved to backlog or next sprint
* [ ] Retrospective notes captured above
* [ ] Follow-up cards created for next sprint
