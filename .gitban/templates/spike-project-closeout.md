...
| **4. Generate Sprint Summary** | [e.g., "Generated SUMMARY.md for sprint archive" or "Link to summary"] | - [ ] Sprint summary generated using `generate_sprint_summary()` tool. |
...
4. **Generate Sprint Summary:**
   ```bash
   # Use generate_sprint_summary tool to create narrative summary
   generate_sprint_summary(
       sprint_folder_name="sprint-project-auth-v2-complete-20250125",
       mode="enhanced",
...
| **`generate_sprint_summary()`** | Generate narrative summary with lessons learned | `generate_sprint_summary("sprint-...", mode="enhanced")` |
...
* [ ] Sprint summary generated using `generate_sprint_summary()` tool.
